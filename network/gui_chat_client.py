...
w_connect.title("connect")
tkinter.Label(w_connect, text="connect").grid(row=0, column=0)
...
c_button = tkinter.Button(w_connect, text="connect", command=connect)
...
frame.pack() # scrollbar, chat_list
